...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="bg-background w-full min-h-screen">
      ...
      {/* Content Section */}
      <section className="container mx-auto max-w-4xl px-6 py-16 md:px-8 md:py-24">
        <div className="rounded-2xl border border-black/[0.08] bg-white/80 p-8 md:p-12 backdrop-blur-xl dark:border-white/[0.08] dark:bg-white/5">
          <div className="prose prose-slate dark:prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-a:text-violet-600 dark:prose-a:text-violet-400">
